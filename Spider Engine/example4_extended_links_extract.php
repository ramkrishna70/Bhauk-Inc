...
//spider all links from http://www.susdescargas.com
...
$obj->start='<!--MAIN-->';
$obj->end=array("to_process"=>array('<!--MAIN_END-->'),"not_to_process"=>array());
$obj->pattern='<a{p[dummy]}href="{p[link]}"{p[dummy]}>{p[dummy]}</a>';
